...
@SpringBootTest
class UserWelcomeEmailGeneratorTest {

    @Autowired
    private JavaMailSender javaMailSender;

    private final UserWelcomeEmailGenerator userWelcomeEmailGenerator = new UserWelcomeEmailGenerator();
    ...
    void shouldReturnExpectedMimeMessagePreparatorForExpirationUserToken() throws Exception {
        ...
        // when
        MimeMessagePreparator actual = userWelcomeEmailGenerator.generateEmail(emailRequest);
